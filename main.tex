...
On data distribution $A$, we only take 1.5x and 1.4x the time of the hash table to do an \insertion and \lookup. 
...
on distribution $A$, we are more than 4x faster than HOT and ART on \insertion, 
...
We believe the most important reason is that Distribution $B$ has high-degree nodes at the bottom levels, 
