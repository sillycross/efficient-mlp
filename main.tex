...
We will refer to this algorithm by EBS, since it employs \textbf{E}ytzinger layout and \textbf{B}-tree-like multi-way \textbf{S}earch.} \cite{binary_search_layout}, 
...
We used the variant that is emperically fastest on our machine, which uses 16-way implicit B-tree layout + Eytzinger layout
+ ``low-level optimizations such as unrolling and conditional moves''
(the ``btree16\_a'' variant in authors' benchmark). It is around 2x faster than std::lower\_bound.
